...
评测直接读取快照，不绕过数据库审核门槛。当前基线覆盖八部法规、2,445 个 Chunk 和 23 个
问题；精确法条、词法检索与倒数排名融合的 Recall@3/5 为 1.0，MRR@5 为 0.8768。新增刑事
问题覆盖盗窃罪法定刑、数额标准、入户盗窃、累犯和认罪认罚。使用 2026-08-08 首批五部法规
与 17 个问题测得的 BGE-M3 数据库混合检索 Recall@3/5 为 1.0，MRR@5 为 0.9412；扩展语料的
生产验收另以同组刑事查询检查向量与词法融合结果。

2026-08-08 首批五个版本已核对标题、制定机关、公布/施行日期、官方详情链接、条文数量和
评测证据后批准进入检索。2026-08-10 又以相同流程批准现行《中华人民共和国刑法》、
《中华人民共和国刑事诉讼法》和《最高人民法院、最高人民检察院关于办理盗窃刑事案件适用
法律若干问题的解释》，共新增 828 个 Chunk。后续快照正文发生变化时仍会生成新的 `pending`
版本，不会继承本次批准状态。
